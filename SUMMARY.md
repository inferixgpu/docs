...
* [Inferix Testnet 2 on Solana & IoTeX](inferix-testnet-2-on-solana-and-iotex/README.md)
  * [Inferix GPU Solutions](inferix-testnet-2-on-solana-and-iotex/inferix-gpu-solutions.md)
  * [Adding GPUs to the Network](inferix-testnet-2-on-solana-and-iotex/adding-gpus-to-the-network/README.md)
    * [For GPU providers](inferix-testnet-2-on-solana-and-iotex/adding-gpus-to-the-network/for-gpu-providers.md)
    * [For Inferix Node Holders](inferix-testnet-2-on-solana-and-iotex/adding-gpus-to-the-network/for-inferix-node-holders.md)
  * [Renting GPU Devices](inferix-testnet-2-on-solana-and-iotex/renting-gpu-devices.md)
  * [User Revenue Calculation](inferix-testnet-2-on-solana-and-iotex/user-revenue-calculation/README.md)
    * [Worker Rewards](inferix-testnet-2-on-solana-and-iotex/user-revenue-calculation/worker-rewards.md)
    * [Rental Revenue](inferix-testnet-2-on-solana-and-iotex/user-revenue-calculation/rental-revenue.md)
    * [Viewing Revenue](inferix-testnet-2-on-solana-and-iotex/user-revenue-calculation/viewing-revenue.md)
    * [Claiming Rewards](inferix-testnet-2-on-solana-and-iotex/user-revenue-calculation/claiming-rewards.md)
  * [GPU Staking & Unstaking](inferix-testnet-2-on-solana-and-iotex/gpu-staking-and-unstaking/README.md)
    * [Staking Requirements](inferix-testnet-2-on-solana-and-iotex/gpu-staking-and-unstaking/staking-requirements.md)
    * [Unstaking GPUs](inferix-testnet-2-on-solana-and-iotex/gpu-staking-and-unstaking/unstaking-gpus.md)
  * [Guide to get tIFX tokens](inferix-testnet-2-on-solana-and-iotex/guide-to-get-tifx-tokens.md)
* [Inferix Testnet 1 on IoTeX](inferix-testnet-1-on-iotex/README.md)
  * [Inferix GPU Solutions](inferix-testnet-1-on-iotex/inferix-gpu-solutions.md)
  * [Adding GPUs to the Network](inferix-testnet-1-on-iotex/adding-gpus-to-the-network.md)
  * [Renting GPU Devices](inferix-testnet-1-on-iotex/renting-gpu-devices.md)
  * [User Revenue Calculation](inferix-testnet-1-on-iotex/user-revenue-calculation.md)
  * [GPU Staking](inferix-testnet-1-on-iotex/gpu-staking.md)
  * [Multiple options to participate in the Staking & Mining Program](inferix-testnet-1-on-iotex/multiple-options-to-participate-in-the-staking-and-mining-program.md)
  * [Special airdrop for Inferix Node Holders! 🎉](inferix-testnet-1-on-iotex/special-airdrop-for-inferix-node-holders.md)
  * [Guide to get tIFX tokens](inferix-testnet-1-on-iotex/guide-to-get-tifx-tokens.md)
  * [FAQ](inferix-testnet-1-on-iotex/faq.md)
