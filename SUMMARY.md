...
* [Inferix Testnet 2 on Solana & IoTeX \[ENDED\]](inferix-testnet-2-on-solana-and-iotex-ended/README.md)
  * [Adding GPUs to the Network](inferix-testnet-2-on-solana-and-iotex-ended/adding-gpus-to-the-network/README.md)
    * [For GPU providers](inferix-testnet-2-on-solana-and-iotex-ended/adding-gpus-to-the-network/for-gpu-providers.md)
    * [For GPU providers without funds](inferix-testnet-2-on-solana-and-iotex-ended/adding-gpus-to-the-network/for-gpu-providers-without-funds.md)
    * [For users without GPUs](inferix-testnet-2-on-solana-and-iotex-ended/adding-gpus-to-the-network/for-users-without-gpus.md)
    * [For Inferix Node Holders](inferix-testnet-2-on-solana-and-iotex-ended/adding-gpus-to-the-network/for-inferix-node-holders.md)
  * [Renting GPU Devices](inferix-testnet-2-on-solana-and-iotex-ended/renting-gpu-devices.md)
  * [User Revenue Calculation](inferix-testnet-2-on-solana-and-iotex-ended/user-revenue-calculation/README.md)
    * [Worker Rewards](inferix-testnet-2-on-solana-and-iotex-ended/user-revenue-calculation/worker-rewards.md)
    * [Rental Revenue](inferix-testnet-2-on-solana-and-iotex-ended/user-revenue-calculation/rental-revenue.md)
    * [Viewing Revenue](inferix-testnet-2-on-solana-and-iotex-ended/user-revenue-calculation/viewing-revenue.md)
    * [Claiming Rewards](inferix-testnet-2-on-solana-and-iotex-ended/user-revenue-calculation/claiming-rewards.md)
  * [GPU Staking & Unstaking](inferix-testnet-2-on-solana-and-iotex-ended/gpu-staking-and-unstaking/README.md)
    * [Staking Requirements](inferix-testnet-2-on-solana-and-iotex-ended/gpu-staking-and-unstaking/staking-requirements.md)
    * [Unstaking GPUs](inferix-testnet-2-on-solana-and-iotex-ended/gpu-staking-and-unstaking/unstaking-gpus.md)
  * [Guide to get tIFX tokens](inferix-testnet-2-on-solana-and-iotex-ended/guide-to-get-tifx-tokens.md)
  * [Why choose Inferix DePIN GPU Solutions?](inferix-testnet-2-on-solana-and-iotex-ended/why-choose-inferix-depin-gpu-solutions.md)
