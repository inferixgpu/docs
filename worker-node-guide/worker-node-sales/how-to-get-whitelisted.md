...
* [**Our referral program for Influencers & Community Leaders (KOLs)**](../../verifier-node-guide/verifier-node-sales/referral-program.md)\
...
However, these free airdrop nodes will not be eligible to participate in [Guaranteed Node Buyback](../../verifier-node-guide/verifier-node-sales/guaranteed-node-buyback.md) program.
